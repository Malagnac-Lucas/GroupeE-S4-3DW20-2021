...
<div class="wrapper">
    ...
    <section class="contenu">
        <h1>
            <!--Il manquait le '.name' pour afficher la météo de la ville en question (Limoges).-->
...
<!--Mauvaise syntaxe de Twig (on includ le fichier "bottom.tpl")-->
<!--On doit "include" le fichier bottom.tpl ce qui donne => ci-dessous-->
{{ include('bottom.tpl') }}
